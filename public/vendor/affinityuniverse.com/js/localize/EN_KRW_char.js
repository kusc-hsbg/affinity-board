...
'getCurrencyFormat' : function(price){ var _format_string = '₩%s'; return _format_string.replace('%s', money_format(price,0,'.',',')); }, 
...
'E_30515' : function(){ return LOCALIZE.convArguments("You cannot change subscription options at this shopping mall.", arguments); },
'E_30516' : function(){ return LOCALIZE.convArguments("The selected option cannot be found. The product option may have changed.", arguments); },
'E_30517' : function(){ return LOCALIZE.convArguments("This option is not available. Please select another option.", arguments); },
'E_30518' : function(){ return LOCALIZE.convArguments("Please select all options.", arguments); },
'E_30508' : function(){ return LOCALIZE.convArguments("You cannot change options or quantities for mobile phone recurring subscriptions.", arguments); },
'설명_최근n개월' : function(){ return LOCALIZE.convArguments("Last %1 month", arguments); },
'설명_서비스점검중' : function(){ return LOCALIZE.convArguments("Service is undergoing maintenance.", arguments); },
'CD_OPM37' : function(){ return LOCALIZE.convArguments("Korean prepaid cards", arguments); },
'E_30514' : function(){ return LOCALIZE.convArguments("The product subscription settings have changed, so you cannot place an order. Please place your order again.", arguments); },
'E_30513' : function(){ return LOCALIZE.convArguments("You cannot specify the shipping start date. Please select again.", arguments); },
'타이틀_배송시작일' : function(){ return LOCALIZE.convArguments("Shipping start date", arguments); },
'타이틀_결제예정일' : function(){ return LOCALIZE.convArguments("Payment due date", arguments); },
'타이틀_사진첨부' : function(){ return LOCALIZE.convArguments("Attach photo", arguments); },
'설명_최대n장장당mMB' : function(){ return LOCALIZE.convArguments("Max %1 page, %2MB per page", arguments); },
'타이틀_선택사항' : function(){ return LOCALIZE.convArguments("Optional", arguments); },
'설명_n장의사진을첨부하지못했어요' : function(){ return LOCALIZE.convArguments("I couldn&#39;t attach %1 photo", arguments); },
'타이틀_용량초과' : function(){ return LOCALIZE.convArguments("Exceeded capacity", arguments); },
'타이틀_미지원확장자' : function(){ return LOCALIZE.convArguments("Unsupported extensions", arguments); },
'타이틀_첨부실패' : function(){ return LOCALIZE.convArguments("Attachment failed", arguments); },
'설명_사진은최대n장까지첨부할수있어요' : function(){ return LOCALIZE.convArguments("You can attach up to %1 photo.", arguments); },
'설명_판매대기중상품' : function(){ return LOCALIZE.convArguments("This item is awaiting sale.", arguments); },
'버튼_보러가기' : function(){ return LOCALIZE.convArguments("Go see", arguments); },
'타이틀_장바구니담기' : function(){ return LOCALIZE.convArguments("Put in a shopping cart", arguments); },
'버튼_상품담기' : function(){ return LOCALIZE.convArguments("Add to cart", arguments); },
'설명_일시적인오류가발생했어요' : function(){ return LOCALIZE.convArguments("A temporary error occurred.", arguments); },
'버튼_거래명세서출력' : function(){ return LOCALIZE.convArguments("Print transaction statement", arguments); },
'타이틀_거래명세서준비중' : function(){ return LOCALIZE.convArguments("Preparing transaction statement", arguments); },
'설명_거래명세서준비중' : function(){ return LOCALIZE.convArguments("I am preparing the transaction statement.", arguments); },
'설명_팝업차단해제후다시시도' : function(){ return LOCALIZE.convArguments("Please try again after disabling your pop-up blocker.", arguments); },
'설명_거래명세서출력실패' : function(){ return LOCALIZE.convArguments("Failed to print the transaction statement.", arguments); },
'E_30068' : function(){ return LOCALIZE.convArguments("Your order has expired due to the payment waiting time. Please place your order again.", arguments); },
'설명_문의작성시개인정보입력주의' : function(){ return LOCALIZE.convArguments("Please do not enter personal information (phone number, bank account number, etc.).", arguments); },
'설명_네이버페이등록안내' : function(){ return LOCALIZE.convArguments("· Naver Pay is a simple payment service that allows you to make payments by registering credit card or bank account information using your Naver ID. · When changing an order, card company benefits and installment payment eligibility may change depending on the respective card company&#39;s policies. · Supported payment methods: All cards/accounts displayed within the Naver Pay payment window.", arguments); },
'E_30507' : function(){ return LOCALIZE.convArguments("Mobile phone billing registration is unavailable.", arguments); },
'버튼_휴대폰등록' : function(){ return LOCALIZE.convArguments("Mobile phone registration", arguments); },
'설명_연관상품' : function(){ return LOCALIZE.convArguments("Related Products", arguments); },
'설명_쿠폰정기혜택서비스' : function(){ return LOCALIZE.convArguments("Coupon Regular Benefit Service", arguments); },
'버튼_AI추천순' : function(){ return LOCALIZE.convArguments("AI Recommended Order", arguments); },
'설명_카드등록에실패' : function(){ return LOCALIZE.convArguments("Card registration failed.", arguments); },
'설명_카드정보를입력하고있습니다진행중' : function(){ return LOCALIZE.convArguments("카드 정보를 입력하고 있습니다...", arguments); },
'설명_카드등록을확인하고있습니다진행중' : function(){ return LOCALIZE.convArguments("Checking card registration...", arguments); },
'설명_네이버페이등록완료' : function(){ return LOCALIZE.convArguments("Npay", arguments); },
'버튼_네이버페이등록' : function(){ return LOCALIZE.convArguments("Naver pay registration", arguments); },
'타이틀_정기구독' : function(){ return LOCALIZE.convArguments("Subscription", arguments); },
'버튼_적용하기' : function(){ return LOCALIZE.convArguments("Apply", arguments); },
'버튼_APP전용' : function(){ return LOCALIZE.convArguments("App Exclusive", arguments); },
'버튼_조건미충족' : function(){ return LOCALIZE.convArguments("Conditions not met", arguments); },
'버튼_오늘만료' : function(){ return LOCALIZE.convArguments("Expires today", arguments); },
'타이틀_무료배송안내' : function(){ return LOCALIZE.convArguments("Free shipping info", arguments); },
'타이틀_배송방식' : function(){ return LOCALIZE.convArguments("Shipping method", arguments); },
'타이틀_크리에이터할인' : function(){ return LOCALIZE.convArguments("Creator discount", arguments); },
'설명_n결제혹은할인적용에따라혜택배송비달라질수있어요' : function(){ return LOCALIZE.convArguments("Benefits and shipping fees may vary depending on %1 payment or applied discounts.", arguments); },
'설명_n착불' : function(){ return LOCALIZE.convArguments("%1 (Cash on delivery)", arguments); },
'설명_결제후안내' : function(){ return LOCALIZE.convArguments("Provided after payment", arguments); },
'설명_기본배송비를따름' : function(){ return LOCALIZE.convArguments("Follows default shipping fee", arguments); },
'설명_배송불가' : function(){ return LOCALIZE.convArguments("Shipping unavailable", arguments); },
'설명_선택국가배송불가' : function(){ return LOCALIZE.convArguments("We can\'t ship to the selected country.", arguments); },
'설명_장바구니공통오류' : function(){ return LOCALIZE.convArguments("An error occurred while processing your cart. Please try again shortly.", arguments); },
'설명_재고가n개남았어요' : function(){ return LOCALIZE.convArguments("Only %1 left in stock", arguments); },
'설명_총상품금액' : function(){ return LOCALIZE.convArguments("Item total", arguments); },
'설명_할인적용에따라배송비달라질수있어요' : function(){ return LOCALIZE.convArguments("Shipping fees may vary depending on the discounts applied.", arguments); },
'버튼_다시불러오기' : function(){ return LOCALIZE.convArguments("Reload", arguments); },
'타이틀_장바구니불러오지못함' : function(){ return LOCALIZE.convArguments("Couldn\'t load your cart due to a temporary issue", arguments); },
'설명_잠시후다시시도' : function(){ return LOCALIZE.convArguments("Please try again shortly.", arguments); },
'설명_6자리만입력' : function(){ return LOCALIZE.convArguments("Enter only 6 digits (Example: 990505)", arguments); },
'타이틀_정기구독결제수단' : function(){ return LOCALIZE.convArguments("Subscription Payment Methods", arguments); },
'설명_등록된결제수단없음' : function(){ return LOCALIZE.convArguments("There is no registered payment method.", arguments); },
'버튼_결제카드등록' : function(){ return LOCALIZE.convArguments("Register payment card", arguments); },
'버튼_결제수단등록' : function(){ return LOCALIZE.convArguments("Register payment method", arguments); },
'설명_결제수단등록항목도움말목록' : function(){ return LOCALIZE.convArguments("<li>Payments are automatically processed according to the subscription cycle using the registered payment method.</li><li> For monthly subscriptions, months without a billing date are charged on the last day of that month. (e.g., Billing date 31 → Charged on February 28)</li><li> Subscription payments are processed at 9 AM on the payment date.</li><li> If you have an ongoing subscription, you cannot delete the payment method.</li>", arguments); },
'타이틀_정기구독결제카드등록' : function(){ return LOCALIZE.convArguments("Register subscription payment card", arguments); },
'타이틀_정기구독결제수단등록' : function(){ return LOCALIZE.convArguments("Register subscription payment method", arguments); },
'설명_등록된결제수단을삭제' : function(){ return LOCALIZE.convArguments("Would you like to delete a registered payment method?", arguments); },
'설명_등록된정기구독결제수단없음' : function(){ return LOCALIZE.convArguments("There is no registered subscription payment method.", arguments); },
'설명_등록한결제수단정기구독상품자동결제됨' : function(){ return LOCALIZE.convArguments("Subscription products are automatically charged to your registered payment method.", arguments); },
'설명_결제수단은마이페이지정기구독관리에서변경가능' : function(){ return LOCALIZE.convArguments("You can change your payment method in My Page &gt; Subscription Management.", arguments); },
'설명_수량할인추가할인' : function(){ return LOCALIZE.convArguments("Extra discount!", arguments); },
'설명_주문페이지이동정보없음' : function(){ return LOCALIZE.convArguments("Could not retrieve order page. Please try again shortly.", arguments); },
'설명_장바구니정보불러오는중' : function(){ return LOCALIZE.convArguments("Loading cart. Please try again shortly.", arguments); },
'설명_주문처리오류' : function(){ return LOCALIZE.convArguments("An error occurred while processing the order.", arguments); },
'버튼_상품둘러보기' : function(){ return LOCALIZE.convArguments("Browse products", arguments); },
'타이틀_장바구니비어있음' : function(){ return LOCALIZE.convArguments("Your cart is empty", arguments); },
'설명_장바구니비어있음' : function(){ return LOCALIZE.convArguments("Add your favorite items!", arguments); },
'설명_사은품정보불러오는중' : function(){ return LOCALIZE.convArguments("Loading free gift info. Please try again shortly.", arguments); },
'설명_사은품선택필요' : function(){ return LOCALIZE.convArguments("Please select a free gift first.", arguments); },
'설명_품절상품n개삭제완료' : function(){ return LOCALIZE.convArguments("%1 sold-out items deleted.", arguments); },
'설명_옵션삭제확인' : function(){ return LOCALIZE.convArguments("Delete this option?", arguments); },
'설명_품절상품n개삭제확인' : function(){ return LOCALIZE.convArguments("Delete %1 sold-out items?", arguments); },
'설명_상품n개삭제확인' : function(){ return LOCALIZE.convArguments("Delete %1 selected items?", arguments); },
'설명_상품삭제확인' : function(){ return LOCALIZE.convArguments("Delete %1?", arguments); },
'타이틀_주문예상금액' : function(){ return LOCALIZE.convArguments("Order total", arguments); },
'버튼_다시시도' : function(){ return LOCALIZE.convArguments("Retry", arguments); },
'설명_주문예상금액불러오는중' : function(){ return LOCALIZE.convArguments("Loading order total", arguments); },
'설명_주문예상금액불러올수없음' : function(){ return LOCALIZE.convArguments("Unable to load order total.\r\nPlease try again shortly.", arguments); },
'설명_수량할인이상구매하면' : function(){ return LOCALIZE.convArguments("or more for", arguments); },
'타이틀_선택한상품' : function(){ return LOCALIZE.convArguments("Selected item", arguments); },
'설명_오류가발생했습니다' : function(){ return LOCALIZE.convArguments("An error occurred.", arguments); },
'설명_비회원주문번호n조회' : function(){ return LOCALIZE.convArguments("Please check with order number %1 in the non-member order lookup.", arguments); },
'버튼_페이코' : function(){ return LOCALIZE.convArguments("PAYCO", arguments); },
'버튼_결제수단삭제' : function(){ return LOCALIZE.convArguments("Remove payment method", arguments); },
'설명_장바구니에상품을담았어요' : function(){ return LOCALIZE.convArguments("Added to your cart.", arguments); },
'버튼_그대로주문하기' : function(){ return LOCALIZE.convArguments("Order now", arguments); },
'설명_n더주문하면무료배송' : function(){ return LOCALIZE.convArguments("%1 more for free shipping", arguments); },
'설명_지금구매하면n' : function(){ return LOCALIZE.convArguments("%1 on this order", arguments); },
'설명_경연테스트' : function(){ return LOCALIZE.convArguments("Test button", arguments); },
'설명_톡체크아웃' : function(){ return LOCALIZE.convArguments("Talk Checkout", arguments); },
'알림_수거지를 선택해주세요' : function(){ return LOCALIZE.convArguments("Please select a collection point.", arguments); },
'설명_즉시기간할인' : function(){ return LOCALIZE.convArguments("Immediate/Time Discount.", arguments); },
'설명_수량별할인전체취소만가능' : function(){ return LOCALIZE.convArguments("Since quantity discounts are applied, only the entire amount can be cancelled.", arguments); },
'설명_수량별할인전체반품만가능' : function(){ return LOCALIZE.convArguments("Due to quantity discounts, only full returns are accepted.", arguments); },
'타이틀_수량별할인' : function(){ return LOCALIZE.convArguments("discount by quantity", arguments); },
'E_40500' : function(){ return LOCALIZE.convArguments("The product has been changed, so exchanges are not possible.", arguments); },
'E_40503' : function(){ return LOCALIZE.convArguments("Exchanges are not possible if the product or option status has changed.", arguments); },
'타이틀_최소주문금액' : function(){ return LOCALIZE.convArguments("Minimum order amount", arguments); },
'설명_더담으면첫구매혜택모달' : function(){ return LOCALIZE.convArguments("If you add more, you will receive one of the following items<br/> You can purchase it at the special first-purchase price!", arguments); },
'타이틀_상품정보_혜택' : function(){ return LOCALIZE.convArguments("boon", arguments); },
'타이틀_첫구매혜택' : function(){ return LOCALIZE.convArguments("First purchase benefits", arguments); },
'타이틀_혜택보기' : function(){ return LOCALIZE.convArguments("View benefits", arguments); },
'설명_지금회원가입하고첫구매혜택받아보세요' : function(){ return LOCALIZE.convArguments("Sign up now and receive benefits on your first purchase.", arguments); },
'설명_지금구매하면첫구매혜택을드려요' : function(){ return LOCALIZE.convArguments("Buy now and receive first-purchase benefits.", arguments); },
'설명_더담으면첫구매혜택을드려요' : function(){ return LOCALIZE.convArguments("Add more and receive first-purchase benefits.", arguments); },
'설명_금액이같은옵션으로만교환요청' : function(){ return LOCALIZE.convArguments("You can only request an exchange for an option of the same amount.", arguments); },
'타이틀_상품보낼주소' : function(){ return LOCALIZE.convArguments("Address to send the product to", arguments); },
'타이틀_수거지주소' : function(){ return LOCALIZE.convArguments("Collection address", arguments); },
'설명_색상및사이즈변경은교환요청으로진행' : function(){ return LOCALIZE.convArguments("For color and size changes, please proceed with <strong>an exchange request</strong> .", arguments); },
'설명_판매중지' : function(){ return LOCALIZE.convArguments("Sales suspended", arguments); },
'설명_교환옵션혹은교환사유를선택' : function(){ return LOCALIZE.convArguments("Please select an exchange option or reason for exchange.", arguments); },
'타이틀_교환옵션' : function(){ return LOCALIZE.convArguments("Exchange options", arguments); },
'설명_입력형옵션은수정할수없어요' : function(){ return LOCALIZE.convArguments("Input options cannot be modified", arguments); },
'설명_교환할옵션을선택해주세요' : function(){ return LOCALIZE.convArguments("Please select the option you wish to exchange.", arguments); },
'설명_동일한금액의옵션으로만교환요청할수있어요' : function(){ return LOCALIZE.convArguments("You can only request an exchange for an option of the same amount.", arguments); },
'타이틀_상품정보_적립' : function(){ return LOCALIZE.convArguments("Reward Points", arguments); },
'타이틀_상품정보_구매' : function(){ return LOCALIZE.convArguments("purchase", arguments); },
'타이틀_상품정보_배송' : function(){ return LOCALIZE.convArguments("Shipping", arguments); },
'타이틀_상품정보_상품' : function(){ return LOCALIZE.convArguments("Product", arguments); },
'설명_송장번호입력' : function(){ return LOCALIZE.convArguments("Enter invoice number", arguments); },
'설명_사은품' : function(){ return LOCALIZE.convArguments("Free gift", arguments); },
'설명_취소예상환불금액' : function(){ return LOCALIZE.convArguments("After a cancellation/return request <strong>, the refund amount may vary depending on discount benefits, reasons for attribution, and sales policy</strong> .", arguments); },
'설명_반품예상환불금액' : function(){ return LOCALIZE.convArguments("After requesting a cancellation/return, the refund amount may vary depending on <strong>discounts and sales policies</strong> . If the return is due to a reason at the buyer&#39;s expense, the refund amount will be <strong>the amount minus the return shipping cost</strong> .", arguments); },
'타이틀_반품수량' : function(){ return LOCALIZE.convArguments("Return quantity", arguments); },
'타이틀_교환수량' : function(){ return LOCALIZE.convArguments("Exchange quantity", arguments); },
'타이틀_취소수량' : function(){ return LOCALIZE.convArguments("Cancellation quantity", arguments); },
'타이틀_상품수거방법' : function(){ return LOCALIZE.convArguments("How to collect goods", arguments); },
'타이틀_수거해주세요' : function(){ return LOCALIZE.convArguments("Please collect it", arguments); },
'타이틀_직접보낼게요' : function(){ return LOCALIZE.convArguments("I&#39;ll send it to you directly", arguments); },
'타이틀_상품수거지주소' : function(){ return LOCALIZE.convArguments("Product pickup address", arguments); },
'타이틀_상품을보낼주소' : function(){ return LOCALIZE.convArguments("Address to send the product to", arguments); },
'설명_대체환불수단' : function(){ return LOCALIZE.convArguments("If a refund is not processed automatically, such as in the case of a bank transfer order or a PG refund failure, the refund will be made to the account below.", arguments); },
'타이틀_개인사업자' : function(){ return LOCALIZE.convArguments("individual", arguments); },
'타이틀_법인사업자' : function(){ return LOCALIZE.convArguments("corporation", arguments); },
'타이틀_사업자유형' : function(){ return LOCALIZE.convArguments("Business type", arguments); },
'설명_비회원은회원당최대구매수량제한상품주문불가상품명포함' : function(){ return LOCALIZE.convArguments("%1 Product has a maximum purchase quantity per person, so it cannot be ordered as a non-member.", arguments); },
'E_30066' : function(){ return LOCALIZE.convArguments("Not eligible for first purchase discount.", arguments); },
'설명_회원당최대구매수량상품명포함' : function(){ return LOCALIZE.convArguments("The maximum purchase quantity per person for %1 product is %2.", arguments); },
...
'E_40051' : function(){ return LOCALIZE.convArguments("Includes items that are out of stock or unavailable for sale.", arguments); },
...
'설명_선물정보' : function(){ return LOCALIZE.convArguments("Gift Information", arguments); },
...
'설명_품절된상품이없습니다' : function(){ return LOCALIZE.convArguments("There are no sold-out products.", arguments); },
'설명_n1개함께주문시배송비n2' : function(){ return LOCALIZE.convArguments("<span class=\'text-primary text-bold\'>Shipping fee %2</span> when ordering <span class=\'text-primary text-bold\'>%1</span> items together.", arguments); },
...
'버튼_옵션수량변경' : function(){ return LOCALIZE.convArguments("Edit", arguments); },
'버튼_바로구매' : function(){ return LOCALIZE.convArguments("Buy now", arguments); },
'버튼_구매불가' : function(){ return LOCALIZE.convArguments("Out of stock", arguments); },
'버튼_품절상품삭제' : function(){ return LOCALIZE.convArguments("Remove sold-out", arguments); },
...
'타이틀_결제구분' : function(){ return LOCALIZE.convArguments("Payment Classification", arguments); },
'버튼_1회구매' : function(){ return LOCALIZE.convArguments("One-time purchase", arguments); },
...
'설명_선택옵션' : function(){ return LOCALIZE.convArguments("Optional", arguments); },
...
'설명_n옵션을선택해주세요' : function(){ return LOCALIZE.convArguments("Select %1 first.", arguments); },
...
'설명_배송안내툴팁' : function(){ return LOCALIZE.convArguments("Shipping tooltip", arguments); },
...
'설명_장바구니조건부무료배송안내' : function(){ return LOCALIZE.convArguments("<p>%2<br>Free shipping over %1</p>", arguments); },
...
'설명_편의점택배' : function(){ return LOCALIZE.convArguments("Convenience store shipping ", arguments); },
...
'타이틀_조건부무료배송B' : function(){ return LOCALIZE.convArguments("Conditional free shipping", arguments); },
'타이틀_고정배송비' : function(){ return LOCALIZE.convArguments("Flat rate shipping", arguments); },
...
'설명_n일남음' : function(){ return LOCALIZE.convArguments("%1 day(s) remaining", arguments); },
'설명_만료' : function(){ return LOCALIZE.convArguments("Expired", arguments); },
'타이틀_회원그룹이용권' : function(){ return LOCALIZE.convArguments("Member group voucher", arguments); },
...
'타이틀_구매금액별차등배송비' : function(){ return LOCALIZE.convArguments("Shipping based on the total purchase amount per order", arguments); },
'설명_지원하지않는배송비결제방법' : function(){ return LOCALIZE.convArguments("This is unsupported <br> payment method for shipping charge in <em class=\'text-danger\'>the selected country.</em>", arguments); },
...
'버튼_네이버페이' : function(){ return LOCALIZE.convArguments("Naver Pay", arguments); },
...
'설명_상품이존재하지않습니다' : function(){ return LOCALIZE.convArguments("The product does not exist.", arguments); },
...
'설명_수량별N개마다부과' : function(){ return LOCALIZE.convArguments("Charged for every %1", arguments); },
...
'설명_무게수량별배송비이상' : function(){ return LOCALIZE.convArguments("More than %1", arguments); },
'설명_무게수량별배송비미만' : function(){ return LOCALIZE.convArguments("Less than %1", arguments); },
...
'타이틀_수량별차등배송비' : function(){ return LOCALIZE.convArguments("Quantity based shipping", arguments); },
...
'타이틀_반품배송비' : function(){ return LOCALIZE.convArguments("Return shipping fee", arguments); },
...
'설명_상품삭제로주문변경불가' : function(){ return LOCALIZE.convArguments("The order can\'t be edited because the seller has deleted this item.", arguments); },
'설명_옵션정보변경으로주문변경불가' : function(){ return LOCALIZE.convArguments("The order can\'t be edited because the product option has changed by seller. Remove this item from shopping cart and try again.", arguments); },
...
'설명_최대업로드용량안내_게시판' : function(){ return LOCALIZE.convArguments("Maximum upload: 150MB", arguments); },
...
'타이틀_택배소포등기' : function(){ return LOCALIZE.convArguments("Shipping", arguments); },
...
'설명_지원하지않는배송방법' : function(){ return LOCALIZE.convArguments("<em class=\'text-danger\'>This shipping method<br>is not supported<br>in the country selected.</em>", arguments); },
...
'버튼_반품교환' : function(){ return LOCALIZE.convArguments("Returns·Exchanges", arguments); },
...
'설명_장바구니저장실패' : function(){ return LOCALIZE.convArguments("Failed to save cart", arguments); },
...
'설명_장바구니정보가존재하지않습니다' : function(){ return LOCALIZE.convArguments("Cart information does not exist.", arguments); },
'설명_해당장바구니아이템정보가존재하지않습니다' : function(){ return LOCALIZE.convArguments("Cart item information does not exist.", arguments); },
'설명_존재하지않는상품입니다' : function(){ return LOCALIZE.convArguments("This item does not exist.", arguments); },
'설명_필수옵션이개이상선택되어야합니다' : function(){ return LOCALIZE.convArguments("At least one required option must be selected.", arguments); },
'설명_장바구니변경실패' : function(){ return LOCALIZE.convArguments("Failed to edit cart", arguments); },
...
'설명_장바구니삭제실패' : function(){ return LOCALIZE.convArguments("Failed to remove cart items.", arguments); },
'설명_옵션삭제실패' : function(){ return LOCALIZE.convArguments("Failed to delete options.", arguments); },
...
'버튼_전체선택' : function(){ return LOCALIZE.convArguments("Select all", arguments); },
...
'설명_재고부족' : function(){ return LOCALIZE.convArguments("Not enough stock (%1 left)", arguments); },
...
'버튼_필수옵션' : function(){ return LOCALIZE.convArguments("Required option", arguments); },
...
'설명_필수옵션은1개이상존재해야합니다' : function(){ return LOCALIZE.convArguments("There must be at least one required option.", arguments); },
